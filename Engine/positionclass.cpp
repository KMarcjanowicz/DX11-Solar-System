...
void PositionClass::MoveForward(bool keydown)
{
	...
	radians2 = m_rotationX * 0.0174532925f;

	// Update the position.
	m_positionX += sinf(radians) * m_forwardSpeed;
	m_positionZ += cosf(radians) * m_forwardSpeed;
	m_positionY -= sinf(radians2) * m_forwardSpeed;
...
void PositionClass::MoveBackward(bool keydown)
{
	...
	m_positionY += sinf(radians2) * m_backwardSpeed;
...
void PositionClass::TurnLeft(bool keydown)
{
	...
	// Convert degrees to radians.
	radians = m_rotationY * 0.0174532925f + 1.5707963268;

	// Update the position.
	m_positionX -= sinf(radians) * m_leftTurnSpeed / 5;
	m_positionZ -= cosf(radians) * m_leftTurnSpeed / 5;
	// Update the rotation.
...
void PositionClass::TurnRight(bool keydown)
{
	...
	// Update the position.
	m_positionX -= sinf(radians) * m_rightTurnSpeed / 5;
	m_positionZ -= cosf(radians) * m_rightTurnSpeed / 5;
